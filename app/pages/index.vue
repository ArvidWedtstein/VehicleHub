  ...
  <div>
    <div class="relative isolate overflow-hidden py-24 sm:py-32">
      <img
        ...
        alt=""
        class="absolute inset-0 -z-10 size-full object-cover object-right md:object-center rounded"
      />
      <div
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0">
          <h2
            class="text-5xl font-semibold tracking-tight sm:text-7xl text-base-100"
          >
            Welcome
          </h2>
          <p
            class="mt-8 text-lg font-medium text-pretty text-base-200 sm:text-xl/8"
          >
            Manage your vehicles, track expenses and services, and stay on top
            of maintenance with ease. Welcome to your personal Vehicle Hub.
          </p>
        </div>
