...
const vehicleManufacturersCodes = new Map<string, string>([
  ...
  [
    "ABJ",
    "Mitsubishi Colt & Triton pickups made by Mercedes-Benz South Africa 1994–2011",
  ],
  ...
  ["JAA", "Isuzu truck, Holden made by Isuzu"],
  ["JAB", "Isuzu car"],
  ["JAC", "Isuzu SUV"],
  ...
  [
    "JSA",
    "Suzuki ATV & '03 Kawasaki KFX400 ATV made by Suzuki, Suzuki car/SUV (outside N. America)",
  ],
  ...
  [
    "KLA",
    "Daewoo/GM Daewoo/GM Korea (Chevrolet/Alpheon)\nfrom Bupyeong & Kunsan plants",
  ],
  ...
  [
    "LDF",
    "Dezhou Fulu Vehicle Co., Ltd. (motorcycles), BAW Yuanbao electric car (Ace P1 in Norway)",
  ],
  ["LDK", "FAW Bus (Dalian) Co., Ltd."],
  [
    "LDN",
    "Soueast (South East (Fujian) Motor Co., Ltd.) including Mitsubishi made by Soueast",
  ],
  ["LDP", "Voyah, Dongfeng"],
  ...
  [
    "LE4",
    "Beijing Benz & Beijing Benz-Daimler Chrysler Automotive Co. (Chrysler, Mitsubishi, Mercedes-Benz)",
  ],
  ...
  ["LFP", "FAW Car, Bestune, Hongqi (passenger vehicles)"],
  ["LFT", "FAW (trailers)"],
  ...
  ["LNB", "BAIC Motor, Xiaomi SU7 built by BAIC"],
  [
    "LND",
    "JMEV (Jiangxi Jiangling Group New Energy Vehicle Co., Ltd.), Eveasy/Mobilize Limo",
  ],
  ...
  [
    "LS6",
    "Changan Automobile & Deepal Automobile Technology Co., Ltd. & Avatr Technology Co., Ltd.",
  ],
  ...
  [
    "LY4",
    "Chongqing Yingang Science & Technology Group Co., Ltd. (motorcycle)",
  ],
  ...
  [
    "L4Y",
    "Qingqi Group Ningbo Rhon Motorcycle / Ningbo Dalong Smooth Locomotive Industry Co., Ltd.",
  ],
  ...
  ["ML3", "Mitsubishi Motors, Dodge Attitude made by Mitsubishi (Thailand)"],
  ...
  ["MS0", "Super Seven Star Motors Myanmar"],
  ...
  [
    "PRH",
    "Chery (by Chery Alado Holdings [joint venture] at Oriental Assemblers plant)",
  ],
  ["PRX", "Kia/Inokom"],
  ["PR8", "Ford"],
  ...
  ["RK3", "E-Ton Power Tech Co., Ltd. (motorcycle)"],
  ["RK3", "Honda Taiwan"],
  [
    "RK7",
  ...
  [
    "R1J",
    "Jiayuan Power (Hong Kong) Ltd. (Electric Low-Speed Vehicles) (Hong Kong)",
  ],
  ...
  [
    "TSM",
    "Suzuki Hungary (Magyar Suzuki), Fiat Sedici made by Suzuki, Subaru G3X Justy made by Suzuki",
  ],
  ...
  [
    "TT9/117",
    "Ikarus Egyedi Autobusz Gyarto Kft. / Magyar Autóbuszgyártó Kft. / MABI (Hungary)",
  ],
  ["TT9/123", "Ikarus Global Zrt. (Hungary)"],
  ["TWG", "CeatanoBus (Portugal)"],
  [
    "TW1",
    "Toyota Caetano Portugal, S.A. (Toyota Coaster, Dyna, Optimo, Land Cruiser 70 Series)",
  ],
  ...
  [
    "UH9/DA3",
    "DAB - Danish Automobile Building (acquired by Scania) (Denmark)",
  ],
  ...
  [
    "VF1",
    "Renault, Eagle Medallion made by Renault, Opel/Vauxhall Arena made by Renault, Mitsubishi ASX & Colt made by Renault",
  ],
  ["VF2", "Renault Trucks"],
  ["VF3", "Peugeot"],
  ["VF4", "Talbot"],
  ...
  ["VS9/047", "Indox (truck trailers)"],
  ["VS9/057", "SOR Ibérica (truck trailers)"],
  ...
  ["XTF", "GolAZ (Russia)"],
  ["XTH", "GAZ (Russia)"],
  ["XTJ", "Lada Oka bade by SeAZ (Russia)"],
  ["XTK", "IzhAvto (Russia)"],
  ...
  ["Y6L", "Bogdan group, Hyundai made by Bogdan (Ukraine)"],
  ...
  [
    "ZEH",
    "Trigano SpA (former SEA Group); McLouis & Mobilvetta recreational vehicles",
  ],
  ["ZES", "Bimota"],
  ...
  ["1F9/SX2", "Seagrave Fire Apparatus"],
  ...
  [
    "1YV",
    "Mazda made by Mazda Motor Manufacturing USA/AutoAlliance International",
  ],
  [
    "1ZV",
  ...
  [
    "11H",
    "Hendrickson Mobile Equipment, Inc. (fire engines - incomplete vehicle)",
  ],
  ["12A", "Avanti"],
  ...
  [
    "3FR",
    "Ford F-650/F-750 made by Blue Diamond Truck Co. (incomplete vehicle)",
  ],
  ["3FT", "Ford truck"],
  ["3F6", "Sterling Bullet"],
  ...
  [
    "4KB",
    "Chevrolet W-Series incomplete vehicle (gas engine only) made by Isuzu Motors",
  ],
  [
    "4KD",
    "GMC W-Series incomplete vehicle (gas engine only) made by Isuzu Motors",
  ],
  ...
  [
    "4UZ",
    "Freightliner Custom Chassis Corporation &\ngas-powered Mitsubishi Fuso trucks assembled by Freightliner Custom Chassis &\nThomas Built Buses FS-65 & Saf-T-Liner C2",
  ],
  ...
  [
    "44K",
    "HME Inc. (fire engines - incomplete vehicle) (HME=Hendrickson Mobile Equipment)",
  ],
  ...
  [
    "7AT",
    "VIN assigned by the New Zealand Transport Authority Waka Kotahi from 29 November 2009",
  ],
  ...
  [
    "7A8",
    "VIN assigned by the New Zealand Transport Authority Waka Kotahi before 29 November 2009",
  ],
  ...
  [
    "7G2",
    "Tesla, Inc. truck (used for Nevada-built Semi Trucks & Texas-built Cybertruck)",
  ],
  ["7H4", "Hino truck"],
  ...
  ["9BD", "Fiat Brazil, Ram made by Fiat Brasil"],
  ["9BF", "Ford Brazil"],
  ...
  [
    "93C",
    "Chevrolet SUV [Tracker] or pickup [Montana] (sold in Mexico, made in Brazil)",
  ],
  ...
  [
    "95V",
    "Dafra Motos (motorscooters from SYM) & Ducati, KTM, & MV Agusta assembled by Dafra",
  ],
...
const isInRange = (range: string, code: string): boolean => {
  ...
  const getIndices = (indCode: string): [number, number] => {
    return [
      sequence.indexOf(indCode[0] || ""),
      sequence.indexOf(indCode[1] || ""),
    ];
  };
